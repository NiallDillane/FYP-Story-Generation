...
API endpoints were exposed as shown in Listing~\ref{api_endpoints}, assigning the function a destination and method. We will discuss how this was able to communicate with our React App in Section~\ref{link_api_react}.

\lstinputlisting[language=HTML, fontadjust=\true, float, firstline=27, lastline=28, caption=API Endpoints, label={api_endpoints}]
