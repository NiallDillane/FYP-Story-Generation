...
To analyse a sample story, we will reference Appendix~\hyperref[appendix:story]{B}: "Voices". The system was only provided the generic starting phrase "Once upon a time", and left to generate a short story autonomously. I believe this exhibits many of the factors that make up a good story, touched on in Section~\ref{stories}.
