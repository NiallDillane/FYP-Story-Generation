...
The story posted can be found in Appendix~\hyperref[appendix:story2mod]{D}, modified slightly from the original generation in Appendix~\hyperref[appendix:story2]{C}. Ultimately, it did not perform too well\footnote{\href{https://www.reddit.com/r/nosleep/comments/gaccvf/lonely/}{Reddit Post} (\url{https://www.reddit.com/r/nosleep/comments/gaccvf/lonely/})}, but this was not an entirely accurate test of the system. It is supposed to be a much more collaborative effort, so minor faults are acceptable in the name of inspiration. 
